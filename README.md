 ...
 * `install_idrac`
 Install the meta rpm-idrac package. Default: false
 
 * `install_idrac7`
 Install the meta rpm-idrac7 package. Default: false

 * `install_all`
 Install all srv-admin available from the repository. Default: false
